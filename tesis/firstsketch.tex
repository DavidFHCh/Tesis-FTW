...
c\'odigo en figura 2.1, se encargan de solucionar los casos en los que inmediatamente después de 
...
Leyendo mas detenidamente la funci\'on, figura 2.2, se puede observar que las operaciones de balanceo 
...
es por esto que se introducen las definiciones de la figura 2.3.
...
Al poder eliminar nodos de cualquier parte de un \'arbol presenta una problemática muy grande para el 
...
Estas funciones, figura 2.4, 2.5 y 2.6, son tres: $rbal'$, $lbalS$, $rbalS$. La primera de estas 
...
VER FUNCION DEL PARA PODER EXPLICAR EL FUNCIONAMIENTO DE ESTA FUNCION.......
...
;
\end{tikzpicture}
\caption{{\Arn} despues de aplicar funcion append.}
\end{figure}
