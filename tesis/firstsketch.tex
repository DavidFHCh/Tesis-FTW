...
La funci\'on de concatenacion se usa cuando se localiza el elemento que se busca eliminar del {\arn}, 
esto es porque el retirar el nodo del \'arbol da como resultado dos \'arboles que tienen que ser 
concatenados y tienen que respetar los invariantes de los {\arns}. Esto nos da varios casos que 
desarrollaremos a continuación:
Explicar la funcion auxiliar $append_l$
\begin{itemize}
    \item Dos \'arboles vac\'ios: En este caso solamente se juntan como un \'arbol vacío.
    \item Un \'arbol vacío y un árbol cualquiera: El resultado de concatenar cualquier \'arbol, sea $a$, con el vacío es $a$.
    \item Dos arboles con raíces rojas
    \item Dos arboles con raices negras
    \item Dos arboles, uno con raiz negra y el otro con raiz roja
    \item Dos arboles, uno con raiz roja y el otro con raiz negra 
\end{itemize}
