...
`Coq'. Se busca demostrar la corrección y completud de una estructura de datos implementada en este 
...
demostraciones, aqui tenemos dos opciones, traducir a mano o utilizar una herramienta que nos ayude a traducir. Esta herramienta se llama `hs-to-coq'\cite{thrc}.
