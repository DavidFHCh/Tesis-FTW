...
La verificaci\'on formal de un programa usando Coq esta conformada de las siguientes etapas:
\begin{itemize}
...
La primera definici\'on llamada $isRB$, ver figura \ref{inductive_isRB}, tiene tres casos los
