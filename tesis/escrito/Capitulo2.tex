...
incalcanzables en la ejecuci\'on pero que tendrian que ser demostrados como tales.
 ...
 Sin embargo, se realizo trabajo para intentar totalizar las funciones de Haskell y asi poder usar
...
verificar\'an en este trabajo. La idea principal detrás de este algoritmo es que solo se agreguen
hojas al \'arbol binario y se efectúen ``giros''\footnote{funciones de balanceo.} para mantener las
...
%aqui acaba primera revision de capitulo 2.
