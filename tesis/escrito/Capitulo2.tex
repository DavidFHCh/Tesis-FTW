...
usan en la biblioteca estandar de Coq, los cuales son una versi\'on de los {\arns} de Okasaki\cite{Okasaki}; en este caso se usaron
...
A pasear de ello, se intent\'o totalizar las funciones de Haskell y asi poder 
usar la herramienta \textbf{hs-to-coq} y de esta manera facilitar la traducci\'on, pero por las mismas
