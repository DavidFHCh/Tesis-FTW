...
definici\'on inductiva \hyperref[inductive_isRedB]{$nearly\_redblack$} y r no es de color rojo y 
...
Al igual que en \hyperref[lema_6]{$del\_arb$} se hacen los casos de si el elemento a eliminar esta 
...
\end{minted}
        ...
        definida para \'arboles negros, entonces solo nos queda demostrar para \'arbles rojos, sin 
